...
def autoConfigQ():
	class FTGac(xbmcgui.WindowXMLDialog):
		def __init__(self,*args,**kwargs):
			self.title   ='[COLOR %s]Configuracion avanzada automatica[/COLOR]' % (COLOR2)
			...
			self.msgbox='[COLOR %s]Estas son las mejores configuraciones actualmente para su dispositivo.\n\nElija guardar y estos datos se escribiran en advancesettings.xml[/COLOR]\r\n\r\n%s\r\n%s\r\n%s\r\n%s' %(COLOR1, recommended4, recommended1, recommended3, recommended2)
