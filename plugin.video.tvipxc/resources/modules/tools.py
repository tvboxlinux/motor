...
def killxbmc():
	killdialog = xbmcgui.Dialog().yesno('Forzar cierre', '[COLOR white]Estas a punto de cerrar tvipxc', 'Te gustaria continuar[/COLOR]', nolabel='[B][COLOR red] No Cancelar[/COLOR][/B]',yeslabel='[B][COLOR green]Forzar el cierre[/COLOR][/B]')
	if killdialog:
		os._exit(1)
	# else:
	# 	home()
