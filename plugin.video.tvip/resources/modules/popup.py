...
def autoConfigQ():
	class FTGac(xbmcgui.WindowXMLDialog):
		def __init__(self,*args,**kwargs):
			self.title   ='[COLOR %s]Configuracion automatica del buffer[/COLOR]' % (COLOR2)
			...
			recommended1 = '[COLOR %s]Tamaño del cache de video:[/COLOR] [COLOR %s]%s MB[/COLOR]' % (COLOR1, COLOR2, self.recommendedVideo)
			...
			self.msgbox='[COLOR %s]Estas son las mejores configuraciones para su dispositivo.\n\nLos cambios crean el archivo advancesettings.xml[/COLOR]\r\n\r\n%s\r\n%s\r\n%s\r\n%s' %(COLOR1, recommended4, recommended1, recommended3, recommended2)
