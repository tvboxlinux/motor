...
def start(signin):
	if username == "":
		...
		if login_data == 0:
			...
			line1 = "Conexion del servidor exitosa"
...
def addonsettings(url,description):
	...
	if	 url =="clearcache":
		...
		dialog = xbmcgui.Dialog().select('Edit Advanced Settings', ['Configuracion automatica','Enable Fire TV Stick AS','Enable Fire TV AS','Enable 1GB Ram or Lower AS','Enable 2GB Ram or Higher AS','Enable Nvidia Shield AS','Disable AS'])
		if dialog==0:
