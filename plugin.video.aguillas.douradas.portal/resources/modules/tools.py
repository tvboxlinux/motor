...
def addDirMeta(
    ...
    cm.append(('Play Trailer',

              'XBMC.RunPlugin(plugin://plugin.video.Enigma2Tv-Xtra/?mode=9&url='
...
def clear_cache():
    ...
    confirm = xbmcgui.Dialog().yesno(
        ...
        'Please Confirm You Wish To Delete Your Kodi Application Data',
...
class Trailer:
    ...
    def play(self, name, url=None):
        ...
        try:
            ...
            item = control.item(path=url, iconImage=icon,
    ...
    def search(self, url):
        ...
        try:
            ...
            query = urllib.parse.parse_qs(urllib.parse.urllib.parse(url).query)['q' ][0]
    ...
    def resolve(self, url):
        ...
        try:
            ...
            id = url.split('?v=')[-1].split('/')[-1].split('?'

                    )[0].split('&')[0]

            result = client.request('http://www.youtube.com/watch?v=%s'

                                    % id)



            message = client.parseDOM(result, 'div',
            ...
            alert = client.parseDOM(result, 'div',
