...
def main_list(params):
    ...
    plugintools.add_item(action="cambio_mac",         title="Direccion MAC Actual:   "+mac,thumbnail=thmb_cambio_mac,fanart="https://www.miwuki.com/wp-content/uploads/2016/11/gatito-830x623-300x225.jpg",folder= True )    
    plugintools.add_item(action="", thumbnail=thmb_nada,title="[COLOR gray]Archivos locales--------------------------------------------------------------------------[/COLOR]",folder= False )
    plugintools.add_item(action="carga_servidores",    title="Lista de servidores locales",extra='Local' ,thumbnail=thmb_carga_servidores,fanart="https://www.zooplus.es/magazine/wp-content/uploads/2018/04/fotolia_169457098.jpg",folder= True )
    ...
    if escogido=='Fisier_LOCAL':
        ...
        try:    
            ...
            if 'si' in categorias:
                ...
                ret=dialog.select('Elija una direccion MAC de la lista:',lista_macs)
